...
public class CryptoUtils {
    ...
    public static String decrypt(Key key, File inputFile)
            throws CryptoException {
    ...
    private static void doCrypto(int cipherMode, Key key, File inputFile,
        ...
        try {
            Key secretKey = key; // new SecretKeySpec(key.getBytes(), ALGORITHM);
    ...
    private static String doCrypto(int cipherMode, Key key, File inputFile) throws CryptoException {
        try {
            Key secretKey = key; // new SecretKeySpec(key.getBytes(), ALGORITHM);
            Cipher cipher = Cipher.getInstance(TRANSFORMATION);
            cipher.init(cipherMode, secretKey);
